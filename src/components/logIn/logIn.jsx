...
function MyComponent() {
    return (
        <div className='grid place-items-center p-6 grid-cols-1'>
            <div>
                <div className=''>
                    <p class="text-3xl text-gray-900 font-bold dark:text-white mb-6">Connectez vous</p>
                    <div className='flex justify-center gap-6 pt-6'>
                        <button type="button" class="py-2.5 px-11 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Email</button>
                        <button type="button" class="py-2.5 px-11 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Numero de telephone</button>
                    </div>
                    <div className='pt-8'>
                        <form className='flex flex-col justify-center'>
                            ...
                            <button type="submit" class="max-w-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Se connecter</button>
                        </form>
                    </div>
                    <div className='pt-6'>
                        ...
                        <div className='max-w-md flex justify-between mt-6 mb-6'>
